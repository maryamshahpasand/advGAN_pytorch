...
if __name__ == '__main__':
    ...
    classifiers = ['SVM','RBF_SVM','RF', 'LR', 'MLP']#, 'SVM_R1', 'SVM_R2']#, 'SVM_R3', 'SVM_R4', 'SVM_R5', 'SVM_R6', 'SVM_R7', 'SVM_R8', 'SVM_R9', 'SVM_R10', 'SVM_R11' , 'SVM_R12', 'SVM_R13', 'SVM_R14', 'SVM_R15', 'SVM_R16', 'SVM_R17']# ,'RF' , 'RBF_SVM', 'LR', 'DT' , 'KNN', 'MLP']# ,'DNN']
    attackss=['MALJSMA_15','MALJSMA_all']
        ...
        for attack in attackss:
            for feature in featuress:
                ...
                for round in rounds:
                    ...
                    if  attack=='MALJSMA_15':
                        max_distortions = [0.027]
                    else:
                        if feature=='manifest':
                            max_distortions =[0.455]
                        elif feature == 'code':
                            max_distortions = [0.545]
                        else:
                            max_distortions =[1]
                    for max_dist in max_distortions:
                        ...
                        if len(distrotions)!=0:
                            np.save('./models/malJSMA_all/distortion/distortion_'+target+'.npy',distrotions)
                        ...
                        plot_added_featues(added_feature,max_dist,target)
